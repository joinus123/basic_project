        ...
        <section id="configuration">
          <div class="row">
                      <div class="col-lg-6 offset-lg-3 col-12">
                        ...
                        <form action="{{route('update-socialmedia',$views['id'])}}" method="post"  enctype="multipart/form-data">
                            @csrf
                           <div class="row">

                            <div class="col-12 form-group">
                                <label for="">Icon Heading</label>
                                <input type="text" contenteditable="true" spellcheck="true"  value="{{$views['facebook_icon']}}" name="facebook_icon" class="form-control" placeholder="Last Name">
                              </div>

                             <div class="col-12 form-group">
                               <label for="">Icon Heading</label>
                               <input type="text" contenteditable="true" spellcheck="true"  value="{{$views['instragram_icon']}}" name="instragram_icon" class="form-control" placeholder="Last Name">
                             </div>

                             <div class="col-12 form-group">
                                <label for="">Icon Heading</label>
                                <input type="text" contenteditable="true" spellcheck="true"  value="{{$views['twitter_icon']}}" name="twitter_icon" class="form-control" placeholder="Last Name">
                              </div>

                              <div class="col-12 form-group">
                                <label for="">Icon Heading</label>
                                <input type="text" contenteditable="true" spellcheck="true"  value="{{$views['linkedin_icon']}}" name="linkedin_icon" class="form-control" placeholder="Last Name">
                              </div>
                             ...
                             <div class="col-12 form-group">
                               <div class="attached"> <img src="" style="width:80px" alt="">
                                 ...
                                 <input type="file" name="icon_image" id="upload" name="file">
                               </div>
                             </div>
