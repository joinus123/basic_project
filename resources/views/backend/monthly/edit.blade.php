                        ...
                        <form action="" method="post"  enctype="multipart/form-data">
                           ...
                           <div class="row">
                            ...
                            <div class="col-12 form-group">
                                ...
                                <input type="text" contenteditable="true" spellcheck="true"  value="" name="facebook_icon" class="form-control" placeholder="Last Name">
                              </div>

                             <div class="col-12 form-group">
                               <label for="">Icon Heading</label>
                               <input type="text" contenteditable="true" spellcheck="true"  value="" name="instragram_icon" class="form-control" placeholder="Last Name">
                             </div>

                             <div class="col-12 form-group">
                                <label for="">Icon Heading</label>
                                <input type="text" contenteditable="true" spellcheck="true"  value="" name="twitter_icon" class="form-control" placeholder="Last Name">
                              </div>

                              <div class="col-12 form-group">
                                <label for="">Icon Heading</label>
                                <input type="text" contenteditable="true" spellcheck="true"  value="" name="linkedin_icon" class="form-control" placeholder="Last Name">
                              </div>
